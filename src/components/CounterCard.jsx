    ...
    <div className="w-full max-w-sm bg-white border border-slate-100 rounded-2xl shadow-sm p-4 flex flex-col gap-4">
      <div className="flex items-start justify-between">
        ...
        <div className="text-right">
          <div className="text-3xl font-extrabold text-sky-600 tabular-nums">{counter.value}</div>
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-sky-600 text-white shadow hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-300"
        >
        ...
        <button
          ...
          onClick={() => onUpdate(counter.id, -1)}
          className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-sky-100 text-sky-700 hover:bg-sky-200 focus:outline-none focus:ring-2 focus:ring-sky-200"
        >
          <span className="text-xl leading-none">−</span>
        </button>
